      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left space-y-8">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-800 leading-tight">
            The best, fun, and effective way to learn  <span className="text-yellow-500">sign language!</span>
          </h1>
          <p className="text-lg text-gray-500 max-w-md mx-auto lg:mx-0">
            Break down language barriers by learning sign language. Learn for the unheard voices, anytime, anywhere.
          </p>
